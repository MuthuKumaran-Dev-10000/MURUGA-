class MurugaInterpreter:
    ...
    def read_input(self):
        print("Enter your Muruga++ program (type VARATA to end input):")
        while True:
            line = input()
